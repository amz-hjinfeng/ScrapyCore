...
mkdir -p /opt/applications/utralisks/
echo >> /opt/applications/utralisks/utralisks.err.log
echo >> /opt/applications/utralisks/utralisks.out.log
...
autorestart=true
startsecs=1
stderr_logfile=/opt/applications/utralisks/utralisks.err.log
stdout_logfile=/opt/applications/utralisks/utralisks.out.log
EOF
